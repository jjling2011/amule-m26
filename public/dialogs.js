...
;(function InjectDialogs() {
    ...
    $("#dialog-confirm-ok").on("click", () => confirmResolve && confirmResolve())
    $("#dialog-confirm-cancel").on("click", () => confirmReject && confirmReject())
